...
db.serialize(() => {
  ...
  const campaigns = [
    ...
    },
    {
      ...
      body_text: 'Detailed description...',
      goal_amount: 15000,
      milestones: '3000,7500,12000'
    }
  ]

  const campaignStmt = db.prepare(
    'INSERT INTO campaigns (organization_id, image, campaign_bio, body_text, goal_amount, milestones) VALUES (?, ?, ?, ?, ?, ?)'
  )
