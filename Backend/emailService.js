...
const senderEmailAddress = process.env.SMTP_FROM || 'no-reply@donationsplatform.local';
 ...
 */
function buildThankYouEmailForTier({ donorName, campaignBio, donationAmount, donationTier }) {
 ...
 */
function buildMilestoneFollowUpEmail({ donorName, campaignBio, milestoneAmount, totalRaisedAmount }) {
  return {
 ...
 */
function buildCampaignCloseEmail({ donorName, campaignBio, totalRaisedAmount }) {
  return {
