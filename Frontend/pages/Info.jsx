...
Beskrivelse:  AI written info page for the webapp
*/
  ...
  return (
    <section className="info-page">
      ...
      <article id="persondata" className="info-card">
        ...
        <ul>
          <li>
            Navn, e-mail og kontooplysninger ved donation og kampagneoprettelse.
          </li>
          <li>Oplysninger om donationer, beløb og tidspunkt.</li>
          <li>
            Eventuelle samtykkeoplysninger, fx nyhedsbrev og skattefradrag.
          </li>
        ...
        <ul>
          <li>
            Gennemførelse af donationer og kampagnedrift (GDPR art. 6, stk. 1,
            litra b).
          </li>
          <li>
            Overholdelse af retlige forpligtelser, fx bogføring (art. 6, stk. 1,
            litra c).
          </li>
          <li>
            Samtykkebaseret kommunikation, fx nyhedsbrev (art. 6, stk. 1, litra
            a).
          </li>
          <li>
            Sikkerhed, fejlfinding og misbrugsforebyggelse (art. 6, stk. 1,
            litra f).
          </li>
        </ul>
        ...
        <p>
          Vi opbevarer oplysninger så længe, det er nødvendigt for formålet og
          for at opfylde lovkrav. Oplysninger slettes eller anonymiseres, når de
        ...
        <ul>
          ...
          <li>
            Ret til indsigelse mod behandling baseret på legitime interesser.
          </li>
        </ul>
      ...
      <article id="samtykke" className="info-card">
        ...
        <ul>
          ...
          <li>
            Samtykke vedr. skattefradrag bruges kun til det relevante formål.
          </li>
          <li>
            Tilbagetrækning påvirker ikke lovlig behandling foretaget før
            tilbagetrækning.
          </li>
        </ul>
      </article>
