...
function CreateCampaign () {
  ...
  const handleSubmit = async (e) => {
    ...
    // Basic validation
    if (!formData.provider_id || !formData.campaign_bio || !formData.goal_amount) {
  ...
  return (
    <div className='form-page'>
      ...
      <p>Fill out the form below to create a new fundraising campaign. Make sure to provide a compelling title and description to attract donors. You can also set funding milestones to keep your supporters engaged as you progress towards your goal.</p>
      ...
      <form className='campaign-form' onSubmit={handleSubmit}>
          ...
          {isLoading ? ( 
            ...
            >
              ...
              {providers.map(provider => (
                <option key={provider.organization_id} value={provider.organization_id}>
                  {provider.name}
                </option>
              ))}
            </select>
        ...
        <div className='milestones-section'>
          ...
          <p>Define milestones to motivate donors and show progress. These are optional but can help increase engagement. Your subscribing donaters will be notified when these milestones are reached.</p>
