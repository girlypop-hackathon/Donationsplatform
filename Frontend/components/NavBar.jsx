  ...
  return (
    <nav className="navbar">
      ...
      <div className="nav-links nav-left">
        <Link className="nav-action" to="/category" style={navItemStyle}>Category</Link>
        <Link className="nav-action" to="/info" style={navItemStyle}>Info</Link>
      </div>
      ...
      <div className="nav-links nav-right">
        <Link className="nav-action" to="/" style={navItemStyle}>Home</Link>
        <Link className="nav-action" to="/create" style={navItemStyle}>Start Campaign</Link>
